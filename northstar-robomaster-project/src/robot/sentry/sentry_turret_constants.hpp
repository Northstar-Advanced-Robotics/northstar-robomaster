...
/**
 * Turret constants for the sentry.
 *
...
{
static constexpr float BEYBLADE_FF_GAIN = 120.0f;
...
// jumping.
static constexpr float YAW_STATIC_FRICTION_FF_GAIN = 500.0f;
static constexpr float PITCH_STATIC_FRICTION_FF_GAIN = 800.0f;
static constexpr float STATIC_FRICTION_FF_VELOCITY_DEADZONE = 0.05f;  // rad/s
...
static constexpr float SCAN_MAX_PITCH_ANGLE = modm::toRadian(20 + 20);
static constexpr float SCAN_PITCH_SPEED = 2.0f;
