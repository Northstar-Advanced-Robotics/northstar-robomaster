 ...
 * @ingroup robots
 *
 * The drivers object for the test bed, extending taproot's with the peripherals and interfaces this
 * robot actually has. The test bed is a bench fixture rather than a competition robot, so which
 * peripherals are present depends on what is being tested; see `test_def.hpp`.
 *
