...
/**
 * Turret constants for the test bed.
 *
 ...
 */
#ifndef TEST_BED_TURRET_CONSTANTS_HPP_
#define TEST_BED_TURRET_CONSTANTS_HPP_
...
static constexpr float GRAVITY_COMPENSATION_SCALAR = 0.0f;  //-3300.0f;  // 12000 // 7'000;
