 ...
 *
 * Draws a "CV control:  " label plus a circle coloured green or black by whether auto-aim reports
 * being on target.
 */
...
public:
     ...
     * @param[in] cvAimingGovorner The governor polled for on-target state.
     */
    CvAimingIndicator(
