...
public:
     ...
     */
    Line(
        tap::communication::serial::RefSerialData::Tx::GraphicColor color,
        uint16_t x1,
        uint16_t y1,
        uint16_t x2,
        uint16_t y2,
    ...
    Line() : Line(tap::communication::serial::RefSerialData::Tx::GraphicColor::WHITE, 0, 0, 0, 0, 1)
    {
    }
    ...
    {
        tap::communication::serial::RefSerialTransmitter::configLine(
            thickness,
            x1,
            y1,
            x2,
...
private:
    ...
    tap::communication::serial::RefSerialData::Tx::GraphicColor prevColor;
};
...
public:
    ...
    UnfilledRectangle()
        : UnfilledRectangle(
              tap::communication::serial::RefSerialData::Tx::GraphicColor::WHITE,
              0,
              0,
              0,
              0,
    ...
    virtual void finishConfigGraphicData(
        tap::communication::serial::RefSerialData::Tx::GraphicData* graphicData) final
    {
        tap::communication::serial::RefSerialTransmitter::configRectangle(
            thickness,
            x,
            y,
            width + x,
...
public:
    ...
    virtual void finishConfigGraphicData(
        tap::communication::serial::RefSerialData::Tx::GraphicData* graphicData) final
    {
        tap::communication::serial::RefSerialTransmitter::configCircle(
            thickness,
            cx,
            cy,
            r,
...
public:
    ...
    virtual void finishConfigGraphicData(
        tap::communication::serial::RefSerialData::Tx::GraphicData* graphicData) final
    {
        tap::communication::serial::RefSerialTransmitter::configEllipse(
            thickness,
            cx,
            cy,
            width,
...
public:
     ...
     */
    Arc(tap::communication::serial::RefSerialData::Tx::GraphicColor color,
        uint16_t cx,
        uint16_t cy,
        uint16_t width,
        uint16_t height,
    ...
    Arc()
        : Arc(tap::communication::serial::RefSerialData::Tx::GraphicColor::WHITE,
              0,
              0,
              0,
              0,
    ...
    virtual void finishConfigGraphicData(
        tap::communication::serial::RefSerialData::Tx::GraphicData* graphicData) final
    {
        tap::communication::serial::RefSerialTransmitter::configArc(
            startAngle,
            endAngle,
            thickness,
            cx,
...
public:
        ...
        tap::communication::serial::RefSerialData::Tx::GraphicData* graphicData) final
    {
        ...
        tap::communication::serial::RefSerialTransmitter::configFloatingNumber(
            fontSize,
            3,
            thickness,
            textX,
...
public:
    ...
    void configCharacterData(
        tap::communication::serial::RefSerialData::Tx::GraphicCharacterMessage* characterData) final
    {
        setLen(stringLen(string));
        calculateNumbers();
        configGraphicData(&characterData->graphicData);
        tap::communication::serial::RefSerialTransmitter::configCharacterMsg(
            fontSize,
            thickness,
            textX,
            textY,
    ...
    void finishConfigGraphicData(__attribute__((
        unused)) tap::communication::serial::RefSerialData::Tx::GraphicData* graphicData) final
    {
    }
